          ...
          <div className="text-center">
            ...
            <div className="space-y-3">
              <div className="text-white/80">
                <MapPin className="text-brand-yellow mx-auto mb-2" size={16} />
                <p>Rua de Rebolido 42<br />4580-402 Gondalães Paredes</p>
              </div>
              <div className="text-gray-300">
                <Phone className="text-brand-turquoise mx-auto mb-2" size={16} />
                <p>+351 930 682 725</p>
              </div>
              <div className="text-white/80">
                <Mail className="text-brand-coral mx-auto mb-2" size={16} />
                <p>geral@domrealce.com</p>
              </div>
            </div>
          </div>
