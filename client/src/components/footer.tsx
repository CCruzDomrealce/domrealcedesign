  ...
  return (
    <footer id="contactos" className="bg-black border-t border-brand-turquoise py-16">
      <div className="container mx-auto px-4">
        {/* Cartão centralizado */}
        <div className="max-w-2xl mx-auto bg-black/30 rounded-2xl border border-brand-turquoise/20 p-8 mb-8">
          {/* Logo */}
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="text-center space-y-4">
              <div>
                <h4 className="text-sm font-semibold text-brand-coral mb-3">Contacto</h4>
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-center justify-center space-x-2">
                    <MapPin size={14} className="text-brand-yellow" />
                    <span>Rua de Rebolido 42, Gondalães</span>
                  </div>
                  <div className="flex items-center justify-center space-x-2">
                    <Phone size={14} className="text-brand-turquoise" />
                    <span>+351 930 682 725</span>
                  </div>
                  <div className="flex items-center justify-center space-x-2">
                    <Mail size={14} className="text-brand-coral" />
            ...
            <div className="text-center space-y-4">
              <div>
                <h4 className="text-sm font-semibold text-brand-yellow mb-3">Horário</h4>
          ...
          <div className="text-center">
            <h4 className="text-sm font-semibold text-brand-turquoise mb-4">Siga-nos</h4>
            <div className="flex justify-center space-x-3">
              <Button
                size="icon"
                className="w-8 h-8 bg-brand-blue rounded-full text-white hover:bg-blue-600 transition-colors"
              >
              ...
              <Button
                size="icon"
                className="w-8 h-8 bg-brand-coral rounded-full text-white hover:bg-red-500 transition-colors"
              >
              ...
              <Button
                size="icon"
                className="w-8 h-8 bg-brand-turquoise rounded-full text-black hover:bg-cyan-400 transition-colors"
              >
              ...
              <Button
                size="icon"
                className="w-8 h-8 bg-brand-yellow rounded-full text-black hover:bg-yellow-400 transition-colors"
              >
