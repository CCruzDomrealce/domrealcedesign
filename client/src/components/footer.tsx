  ...
  return (
    <footer id="contactos" className="bg-black border-t border-brand-turquoise py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Button variant="link" className="text-white/80 hover:text-brand-yellow transition-colors p-0 h-auto">Impressão Digital</Button></li>
              <li><Button variant="link" className="text-white/80 hover:text-brand-yellow transition-colors p-0 h-auto">Corte de Vinil</Button></li>
              <li><Button variant="link" className="text-white/80 hover:text-brand-yellow transition-colors p-0 h-auto">Fachadas e Letreiros</Button></li>
              <li><Button variant="link" className="text-white/80 hover:text-brand-yellow transition-colors p-0 h-auto">Adesivação de Veículos</Button></li>
              <li><Button variant="link" className="text-white/80 hover:text-brand-yellow transition-colors p-0 h-auto">Comunicação Visual</Button></li>
            </ul>
          </div>
          ...
          {/* Business Hours */}
          <div>
            <h4 className="text-lg font-heading font-semibold text-brand-yellow mb-4">Horário</h4>
        ...
        {/* Social Media */}
        <div className="mb-8">
          <h4 className="text-lg font-heading font-semibold text-brand-turquoise mb-4">Siga-nos</h4>
